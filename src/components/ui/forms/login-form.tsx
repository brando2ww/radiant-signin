...
export const LoginForm: React.FC<LoginFormProps> = ({
  ...
  return (
    <>
      <p className="animate-[fade-slide-in_0.6s_ease-out_forwards] opacity-0 [animation-delay:200ms] text-muted-foreground">Acesse sua conta e continue sua jornada conosco</p>
