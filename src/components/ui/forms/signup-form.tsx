...
export const SignUpForm: React.FC<SignUpFormProps> = ({
  ...
  return (
    <>
      <p className="animate-[fade-slide-in_0.6s_ease-out_forwards] opacity-0 [animation-delay:100ms] text-muted-foreground">Junte-se a nós e comece sua jornada</p>

      <form onSubmit={handleSubmit} className="space-y-5">
        {/* Document Type Selector */}
        <div className="animate-[fade-slide-in_0.6s_ease-out_forwards] opacity-0 [animation-delay:200ms]">
          <label className="block text-sm font-medium text-muted-foreground mb-3">Tipo de Cadastro</label>
          ...
          <GlassInputWrapper>
            <div className="relative">
              <input
                ...
                className="w-full bg-transparent px-4 py-4 pr-12 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none rounded-2xl"
                required
              />
              <button
                type="button"
