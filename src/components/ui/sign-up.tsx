...
export interface SignUpPageProps {
  ...
  description?: string;
  heroImage?: string;
  onSignUp?: (data: { documentType: 'cpf' | 'cnpj'; document: string; name: string; email: string; password: string }) => void;
  onGoogleSignUp?: () => void;
  onBackToLogin?: () => void;
}
...
export const SignUpPage: React.FC<SignUpPageProps> = ({
  logo,
  title = "Criar Conta",
  description = "Junte-se a nós e comece sua jornada",
  heroImage,
  onSignUp,
  onGoogleSignUp,
  onBackToLogin
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSignUp?.({ documentType, document: documentValue, name, email, password });
  };
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="animate-[fade-slide-in_0.6s_ease-out_forwards] opacity-0 [animation-delay:200ms]">
              <label className="block text-sm font-medium text-foreground/90 mb-3">Tipo de Cadastro</label>
            ...
            <div className="animate-[fade-slide-in_0.6s_ease-out_forwards] opacity-0 [animation-delay:600ms]">
              <label className="block text-sm font-medium text-foreground/90 mb-2">Senha</label>
              <GlassInputWrapper>
            ...
            <div className="animate-[fade-slide-in_0.6s_ease-out_forwards] opacity-0 [animation-delay:700ms]">
              <label className="block text-sm font-medium text-foreground/90 mb-2">Confirmar Senha</label>
              <GlassInputWrapper>
                <div className="relative">
                  <input
            ...
            <div className="animate-[fade-slide-in_0.6s_ease-out_forwards] opacity-0 [animation-delay:850ms] relative">
            ...
            <button
              ...
              className="animate-[fade-slide-in_0.6s_ease-out_forwards] opacity-0 [animation-delay:900ms] w-full flex items-center justify-center gap-3 rounded-2xl border border-border bg-background py-4 font-medium text-foreground hover:bg-accent transition-colors"
            >
              <GoogleIcon />
